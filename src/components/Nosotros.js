        ...
        <section id="nosotrosSec">
            ...
            <div id="aboutRow">
                ...
                <div id="aboutImg" data-aos="fade-left">
                    <img src="bosque.PNG" id="imgRound" />
            ...
            <div id="rowAboutDiv">
                ...
                <div id="aboutPMiddle" data-aos="fade-up">
                    <h2 id="aboutTitle">Lorem Ipsum</h2>
                    <div id="middlePDiv">
                        <p id="middlePleft">
                    ...
                    <div id="imgDivMiddle" data-aos="fade-left"><img src="cafeSol.PNG" id="imgRoundMiddle" />
                    </div>
                </div>
            ...
            <div id="aboutRowSwitch">
                ...
                <div id="aboutPSwitch" data-aos="fade-up">
